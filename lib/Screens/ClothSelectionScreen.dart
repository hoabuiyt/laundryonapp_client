...
class ClothScreen extends ConsumerStatefulWidget {
  final double calculatedPrice;

  const ClothScreen({super.key, required this.calculatedPrice});

  @override
  ClothScreenState createState() => ClothScreenState();
}

final TextEditingController _searchString = TextEditingController();

class ClothScreenState extends ConsumerState<ClothScreen> {
  ...
  void filterList() {
    ...
    setState(
      () {
        filteredGarments = garments.where(
          (item) {
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) =>
                                const DeliveryTypeScreen(type: 'laundry'),
                          ),
                        );
                        updateLaundryOrderPayload();
                      },
                            ...
                            Column(
                              children: [
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      '${widget.calculatedPrice.toStringAsFixed(0)} CDN',
                                      style: GoogleFonts.poppins(
                                        fontSize: 14,
                                        height: 21 / 14,
                                        color: Colors.white,
