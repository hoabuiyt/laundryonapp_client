...
class DryCleaningOrderSummaryScreen extends ConsumerStatefulWidget {
  const DryCleaningOrderSummaryScreen({super.key});

  @override
  DryCleaningOrderSummaryScreenState createState() =>
      DryCleaningOrderSummaryScreenState();
}

class DryCleaningOrderSummaryScreenState
    extends ConsumerState<DryCleaningOrderSummaryScreen> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final DryCleaningOrderPayload dryCleaningOrderPayload =
        ref.read(dryCleaningOrderPayloadProvider);

    final List<GarmentType> finalSelectedGarments =
        dryCleaningOrderPayload.selectedGarments;
    return Scaffold(
          ...
          children: [
            ...
            Positioned(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  postDryCleaningOrder(defaultAddressId!, ref).then((_) {
