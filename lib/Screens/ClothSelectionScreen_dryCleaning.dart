...
class ClothScreenDryCleaning extends ConsumerStatefulWidget {
  const ClothScreenDryCleaning({super.key});

  @override
  ClothScreenDryCleaningState createState() => ClothScreenDryCleaningState();
}

class ClothScreenDryCleaningState
    extends ConsumerState<ClothScreenDryCleaning> {
  ...
  void initState() {
    ...
    filteredGarments = dryCleaningGarments;
  }

  @override
  void dispose() {
    print('Disposing ClothScreenDryCleanState');
  ...
  void filterList() {
    ...
    setState(
      () {
        filteredGarments = dryCleaningGarments.where(
          (item) {
  ...
  updateLaundryOrderPayload() {
    ref
        .read(dryCleaningOrderPayloadProvider.notifier)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const PreferredSize(
        ...
        child: ServiceAppbar(
          TextSvg: 'assets/Dry_Clean-text.svg',
          MainPng: 'assets/Dry_Clean-main.png',
        ),
      ),
      body: Stack(
        children: [
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).push(
                          MaterialPageRoute(
                            builder: (context) =>
                                const DeliveryTypeScreen(type: 'dryCleaning'),
                          ),
                        );
                        updateLaundryOrderPayload();
                      },
